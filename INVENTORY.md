...
[`PROCESS.md`](PROCESS.md). По каждой единице — решение и причина.
...
| ~~`plan-reviewer`~~ | rdudov `07`, 256 строк | **не брать как ревьюера** — гейта на `planning` нет ([`PROCESS.md`](PROCESS.md)). Критерии покрытия переезжают чеклистом внутрь планировщика |
